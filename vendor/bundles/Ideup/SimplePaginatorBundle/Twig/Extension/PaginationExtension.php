...
class PaginationExtension extends \Twig_Extension{
	...
	public function getFunctions() {
		return array(
		    ...
		    'pagination_sort' => new \Twig_Function_Method($this, 'sort', array('is_safe' => array('html'))), 			
		);
	}
	...
	public function sort($routeName=NULL, $alias=NULL, $column=NULL, $paginatorId=NULL)
	{
	    return $this->pagebar->sort($routeName, $alias, $column, $paginatorId);
	}
